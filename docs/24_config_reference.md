...
19 structs and 201 fields emitted from `rust/mumdia/crates/mumdia-core/src/config.rs`, plus 27 enumerations, 1 named profile(s), 88 environment variables read and 19 set.
