...
19 structs and 195 fields emitted from `rust/mumdia/crates/mumdia-core/src/config.rs`, plus 25 enumerations, 1 named profile(s), 80 environment variables read and 19 set.
