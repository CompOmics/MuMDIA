...
`Config` (rust/mumdia/crates/mumdia-core/src/config.rs:1912). stage document: [docs/02_config_and_data_model.md](02_config_and_data_model.md).
...
`GroupsConfig` (rust/mumdia/crates/mumdia-core/src/config.rs:1893).
...
(rust/mumdia/crates/mumdia-core/src/config.rs:1869)
...
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2708: env read via closure of `&mut flushed``
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2726: env read via closure of `&mut cand_hits``

## Coverage

19 structs and 192 fields emitted from `rust/mumdia/crates/mumdia-core/src/config.rs`, plus 25 enumerations, 1 named profile(s), 65 environment variables read and 19 set.
