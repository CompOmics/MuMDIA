...
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2786: env read via closure of `&mut flushed``
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2804: env read via closure of `&mut cand_hits``
