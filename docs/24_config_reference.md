...
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2789: env read via closure of `&mut self``
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2944: env read via closure of `&mut self``
