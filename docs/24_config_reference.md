...
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2720: env read via closure of `&mut flushed``
- `rust/mumdia/crates/mumdia/src/stages/extract.rs:2738: env read via closure of `&mut cand_hits``
